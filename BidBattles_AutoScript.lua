...
local rawScriptUrl = "https://raw.githubusercontent.com/yourusername/yourrepo/main/BidBattles_AutoScriptWithUI.lua"
...
--------------------------------------------------------------------------------
--  Below is the full autobid script with elegant UI design you should host on GitHub
--  Save this as BidBattles_AutoScriptWithUI.lua and replace the rawScriptUrl above
--------------------------------------------------------------------------------
